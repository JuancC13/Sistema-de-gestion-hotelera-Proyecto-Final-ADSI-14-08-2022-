    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url('administrador')}}">
                ...
                <div class="sidebar-brand-text mx-3">SGH<!--sup>2</sup--></div>
            </a>
            <h6 class="subTituloApp">Sistema de Gestion Hotelera</h6>
           ...
           <!-- Nav Item - Menu desplegable de Tipo de Servicios -->
           <li class="nav-item">
            <a class="nav-link @if(!request()->is('admin/tiposervicio*')) collapsed @endif" href="#" data-toggle="collapse" data-target="#tiposerviciosManager"
                aria-expanded="true" aria-controls="collapseTwo">
                <i class="fas fa-fw fa-ticket"></i>
                <span>Tipo de Servicios</span>
            </a>
            <div id="tiposerviciosManager" class="collapse @if(request()->is('admin/tiposervicio*')) show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{url('admin/tiposervicio/create')}}">Añadir nuevo &nbsp; &nbsp; <i class="fas fa-plus"></i></a>
                    <a class="collapse-item" href="{{url('admin/tiposervicio')}}">Ver todo &nbsp; &nbsp; <i class="fas fa-search"></i></a>
                </div>
            </div>
        </li>


        <!-- Nav Item - Menu desplegable de Servicios -->
        <li class="nav-item">
            <a class="nav-link @if(!request()->is('admin/servicio*')) collapsed @endif" href="#" data-toggle="collapse" data-target="#serviciosManager"
                aria-expanded="true" aria-controls="collapseTwo">
                <i class="fas fa-fw fa-tags"></i>
                <span>Servicios</span>
            </a>
            <div id="serviciosManager" class="collapse @if(request()->is('admin/servicio*')) show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{url('admin/servicio/create')}}">Añadir nuevo &nbsp; &nbsp; <i class="fas fa-plus"></i></a>
                    <a class="collapse-item" href="{{url('admin/servicio')}}">Ver todo &nbsp; &nbsp; <i class="fas fa-search"></i></a>
                </div>
            </div>
        </li>
            ...
            <li class="nav-item">
                ...
                <div id="tipoempleadoManager" class="collapse @if(request()->is('admin/tipoempleado*')) show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{url('admin/tipoempleado/create')}}">Añadir nuevo &nbsp; &nbsp; <i class="fas fa-plus"></i></a>
                        <a class="collapse-item" href="{{url('admin/tipoempleado')}}">Ver todo &nbsp; &nbsp; <i class="fas fa-search"></i></a>
                    </div>
                </div>
            </li>


            <!-- Nav Item - Menu desplegable de Empleados -->
            <li class="nav-item">
                ...
                <div id="empleadoManager" class="collapse @if(request()->is('admin/empleado*')) show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{url('admin/empleado/create')}}">Añadir nuevo &nbsp; &nbsp; <i class="fas fa-plus"></i></a>
                        <a class="collapse-item" href="{{url('admin/empleado')}}">Ver todo &nbsp; &nbsp; <i class="fas fa-search"></i></a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="{{url('administrador/logout')}}">
                    <i class="fas fa-fw fa-sing-out-alt"></i>
                    <span>Cerrar Sección</span></a>
            </li>
